...
After [configuring your AS on the SCIONLab website](/content/config/create_as/) and [installing SCION](/content/install/) you should now have a running SCIONLab AS. Follow the steps below to check that it is working as expected.
...
If any of the checks fail, head over to the [Troubleshooting Guide](/content/faq/troubleshooting/)
...
This should show all entries as green. If there are any failed services in this list, start [troubleshooting](/content/faq/troubleshooting/)
...
Passing this test is a condition sufficient to say that your AS works as expected. If it fails, please refer to [the troubleshooting section](/content/faq/troubleshooting/).
