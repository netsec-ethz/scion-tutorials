...
```shell
sensorfetcher -s 1-16,[192.33.93.173]:42003 -c 1-1006,[10.0.2.15]:42001
```
...
```shell
python3 ${GOPATH}/src/github.com/perrig/scionlab/sensorapp/sensorserver/sensorreader.py | sensorserver -s 1-16,[192.33.93.173]:42003 &
```
...
```shell
python3 ${GOPATH}/src/github.com/perrig/scionlab/sensorapp/sensorserver/timereader.py | sensorserver -s 1-16,[192.33.93.173]:42003 &
```
