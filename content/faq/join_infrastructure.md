...
| :------------- | :----------: | :-----------: | -----------: |
| ICMP | | 0.0.0.0/0 | Heartbeats |
| IP | ALL | 0.0.0.0/0 | Outgoing connectivity |

{% include alert type="note" content="
In case of stateful firewalls in the network, all the rules can be changed into a simple "ALLOW ESTABLISHED" rule in order to facilitate the management of the rulesets.
" %}
