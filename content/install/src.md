...
If you're planning on making modifications to the SCION implementation, you can build SCION from sources and run your SCIONLab AS with your own version of SCION.
