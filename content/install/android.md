...
SCION for Android currently only supports a SCION end host configuration, as described [in this tutorial](/content/advanced/setup_endhost/)
" %}
...
1. [Connecting to SCIONLab as an endhost](/content/advanced/setup_endhost/) &ndash; Connect to the already running SCION topology as a mobile end host through an existing SCION setup.
