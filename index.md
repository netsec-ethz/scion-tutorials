...
For more detailed information, follow the instructions in the [Installation](install/index.html) and
[Configuration](config/create_as.html) sections.
...
3. Install [Vagrant and VirtualBox](install/vm.html)
